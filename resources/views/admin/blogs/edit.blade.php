                ...
                <form class="col-12" action="{{ route('admin.blogs.update', $blog -> id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-sm-12 col-md-12">
                                    ...
                                    <select name="country_id" class="form-control">
                                        ...
                                        @foreach ($countries as $country)
                                            <option value="{{ $country -> id }}" {{ $blog -> country_id == $country -> id ? 'selected' : '' }}>{{ $country -> name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-sm-12 col-md-12">
                                    ...
                                    <select name="city_id" class="form-control">
                                        ...
                                        @foreach ($cities as $city)
                                            <option value="{{ $city -> id }}" {{ $blog -> city_id   == $city -> id ? 'selected' : '' }}>{{ $city -> name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-lg-6">
                            ...
                            <span class="text-danger mx-1">{{ $message }}</span>
                            @enderror
                            <input type="text" name="email" class="form-control form-control-sm input-sm" value="{{ $blog -> email }}">
                        </div>
